 ...
 */
public class RotateVectorView extends ImageView implements Rotatable {
    ...
    public RotateVectorView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public RotateVectorView(Context context) {
        super(context);
    }
